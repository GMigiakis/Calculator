class Calculator {
  constructor(previousOperantTextElement, curentOperantTextElement) {
    ...
    this.curentOperantTextElement = curentOperantTextElement;
    this.clear();
  }
  ...
  delete() {
    this.curentOperant = this.curentOperant.toString().slice(0, -1);
  }
  ...
  chooseOperation(operation) {
    ...
    this.previousOperant = this.curentOperant;
    this.curentOperant = "";
  }
  ...
  compute() {
    ...
    this.curentOperant = computation;
    this.operation = undefined;
    this.previousOperant = "";
  }
  ...
  updateDisplay() {
    this.curentOperantTextElement.innerText = this.getDisplayNumber(this.curentOperant)
